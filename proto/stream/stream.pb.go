...
type Message struct {
	...
	Timestamp int64  `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // Unix nanoseconds, set by sender
	Payload   []byte `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"`      // Configurable size to control throughput
}
...
var file_stream_stream_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x22, 0x51, 0x0a,
	...
	0x32, 0x43, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x32, 0x0a, 0x0a, 0x42, 0x69, 0x44, 0x69, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12,
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x64, 0x65, 0x61, 0x6e, 0x37, 0x35, 0x2f, 0x65, 0x62, 0x70, 0x66,
	0x2d, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x65, 0x78, 0x70, 0x65, 0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x62, 0x06, 0x70,
...
var file_stream_stream_proto_depIdxs = []int32{
	0, // 0: stream.StreamService.BiDiStream:input_type -> stream.Message
	0, // 1: stream.StreamService.BiDiStream:output_type -> stream.Message
